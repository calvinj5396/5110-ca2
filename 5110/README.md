...
| 阈值 | 适用场景 | 事件数量 |
|------|----------|----------|
| 0.1-0.15 | 低对比度、细微变化 | 多 |
| 0.2-0.3 | 一般场景（推荐） | 中等 |
| 0.35-0.5 | 高对比度、快速运动 | 少 |
...
| 累积时间 | 视觉效果 | 适用场景 |
|----------|----------|----------|
| 0.02-0.03s | 稀疏、清晰 | 快速运动 |
| 0.033-0.05s | 标准（推荐） | 一般场景 |
| 0.06-0.1s | 密集、轨迹明显 | 慢速运动 |
...
| 视频规格 | 帧数 | 单进程耗时 | 多进程耗时 | 加速比 |
|----------|------|-----------|-----------|--------|
| 320x240, 30fps | 300 | ~15s | ~5s | 3x |
| 640x480, 30fps | 300 | ~45s | ~12s | 3.75x |
| 1280x720, 30fps | 300 | ~180s | ~35s | 5.1x |
